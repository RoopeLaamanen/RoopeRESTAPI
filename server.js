...
app.get('/configuration', function (request, response) {
  ...
  const filename = '/home/centria/projects/SulautetutJärjestelmät/SulautetutJarjestelmat/BlobDetection/configuration.xml';
...
app.get('/image', function (request, response) {
  ...
  const filename = '/home/centria/projects/SulautetutJärjestelmät/SulautetutJarjestelmat/RESTAPI/Responses/Image.jpg';
  fileSystem.exists(filename,  function(exists) {
    if(exists) {
